...
static void	testReverseIterators() {
	...
	MutantStack<int>					stack = createStack();
	MutantStack<int>::rev_iterator	itStack = stack.rbegin();
	MutantStack<int>::rev_iterator	iteStack = stack.rend();
	++itStack;
	--itStack;
	while (itStack != iteStack) {
		std::cout << *itStack << std::endl;
...
static void	testConstReverseIterators() {
	...
	const MutantStack<int>						stack = createStack();
	MutantStack<int>::const_rev_iterator	itStack = stack.rbegin();
	MutantStack<int>::const_rev_iterator	iteStack = stack.rend();
	++itStack;
	--itStack;
	while (itStack != iteStack) {
		std::cout << *itStack << std::endl;
